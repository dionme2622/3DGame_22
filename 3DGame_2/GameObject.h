...
public:
	...
	virtual void Animate(float fElapsedTime);
	virtual void Animate(float fElapsedTime, XMFLOAT3 pos);
};
...
public:
	CExplosiveObject();
	CExplosiveObject(CPlayer* pPlayer);
...
public:
	CEnemyObject();
	CEnemyObject(CPlayer* pPlayer);
	virtual ~CEnemyObject();

	float						m_fBulletEffectiveRange = 400.0f;	// 사거리
